...
public class BackgroundBot1 : MonoBehaviour
{
    CharacterController botOne;

    public static string lastHitter;
    ...
    void Start()
    {
        ...
        botOne = GetComponent<CharacterController>();
    ...
    private void Update()
    {
            ...
            if (botOne.isGrounded)
            {
                if (lastHitter == "bot2")
                {
                    ...
                    else
                    {
                        ...
                        if (delayStarted == true)
                        {
                            if (BackgroundBot2.xTargetHitTo >= -3)
                            {
                                moveDirection = new Vector3(BackgroundBot2.xTargetHitTo * 0.85f - transform.position.x,
                                    0, BackgroundBot2.zTargetHitTo * 0.95f - transform.position.z);
                            }
                            else
                            {
                                moveDirection = new Vector3(BackgroundBot2.xTargetHitTo * 0.8f - transform.position.x,
                                    0, BackgroundBot2.zTargetHitTo * 0.9f - transform.position.z);
                            }
                        }
                        else
                        {
        ...
        if (allowMovement == false && botOne.isGrounded)
        {
        ...
        // Moves the player
        botOne.Move(moveDirection * Time.deltaTime);
    }
    ...
    {
        if (strokePossible == 1 && lastHitter != "bot1")
        {
            PlayAnimation();
